...
public class FindRecentApplications extends TransactionUserCase<Void, List<ApplicationData>, Dao> {

    public FindRecentApplications(ServiceRegistry serviceRegistry) {
        super(serviceRegistry);
    }

    @Override
    protected List<ApplicationData> transactionalExecute(Void request, Dao dao) {
        List<DAOSupport.Result> resultList = dao.getLastLaunchedApplications();
